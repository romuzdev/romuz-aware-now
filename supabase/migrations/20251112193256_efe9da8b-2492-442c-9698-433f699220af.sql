...
-- =========================================================
-- J4) Schedules (for Supabase cron or Lovable scheduler)
-- =========================================================

-- Note: Adjust interval as needed inside Lovable scheduler UI.
-- Example pseudo-commands for Lovable cron:
-- schedule every 6 hours
--  -> call public.fn_job_check_tenant_health();
--  -> call public.fn_job_detect_drift();
-- schedule every 12 hours
--  -> call public.fn_job_process_deprovision();
