-- Fix seed_demo_actions to accept 'admin' role
-- The enum app_role only has: admin, analyst, manager, viewer
-- So we update the RBAC check to use 'admin' or 'analyst'
...
BEGIN
  ...
  -- FIX: Update RBAC check to match actual enum values
