...
function LMSSidebar() {
  ...
  // Determine if user is on admin or employee routes
  const isAdminRoute = location.pathname.startsWith("/lms");
          ...
          {!collapsed && (
            <div className="flex flex-col">
              <span className="text-sm font-semibold">
                {i18n.language === "ar" ? "نظام التدريب" : "LMS"}
              </span>
                ...
                return (
                  <SidebarMenuItem key={item.url}>
                    <SidebarMenuButton
                      asChild
                      isActive={isActive}
                      tooltip={collapsed ? (i18n.language === "ar" ? item.title : item.titleEn) : undefined}
                    >
                      <NavLink to={item.url}>
