  ...
  const onSubmit = async (data: ContractFormData) => {
    ...
    try {
      const payload = {
        ...
        contract_title_ar: data.contract_title_ar,
        contract_title_en: data.contract_title_en || null,
        ...
        has_termination_clause: data.has_termination_clause,
        has_data_protection_clause: data.has_data_protection_clause,
        has_liability_clause: data.has_liability_clause,
        has_confidentiality_clause: data.has_confidentiality_clause,
        requires_legal_review: data.requires_legal_review,
